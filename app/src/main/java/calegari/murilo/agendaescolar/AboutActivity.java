...
public class AboutActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		copyrightElement
				...
				.setOnClickListener(v -> openCopyrightDialog());
	...
	private void openCopyrightDialog() {
		Attribution SCHOOL_VECTOR_FREEPIK = ((new Attribution.Builder("School vector")
				.addCopyrightNotice("Created by freepik - wwww.freepik.com")
				.setWebsite("https://www.freepik.com/free-photos-vectors/school"))
				.build());

		Attribution BACKGROUND_VECTOR_FREEPIK = ((new Attribution.Builder("Background Vector")
				.addCopyrightNotice("Created by pikisuperstar - www.freepik.com")
		...
		attributionPresenter.showDialog(getString(R.string.copyright));
	}
